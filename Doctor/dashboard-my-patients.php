        ...
        <div class="container-fluid overflow-hidden">
            <div class="row margin-tb-90px margin-lr-10px sm-mrl-0px">
                ...
                <div class="margin-tb-45px full-width">
                    ...
                    $query = "SELECT patients.username, appointment.appointment_id, patients.first_name , 
                    patients.last_name,patients.email,patients.gender,patients.age ,doctors.id FROM appointment JOIN patients ON patients.id = appointment.patient_id 
                    JOIN doctors ON appointment.doctor_id = doctors.id  where doctors.id =1";
