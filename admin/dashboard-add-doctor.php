            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <ul class="navbar-nav navbar-sidenav background-main-color admin-nav" id="admin-nav">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Add Listing">
                        <a class="nav-link active" href="dashboard-add-doctor.html">
        ...
        <div class="content-wrapper">
            <div class="container-fluid overflow-hidden">
                <div class="row margin-tb-90px margin-lr-10px sm-mrl-0px">
                        ...
                        <div class="padding-30px background-white border-radius-20 box-shadow">
                            ...
                            <form>
                                <div class="form-group margin-bottom-20px">
                                    <label><i class="far fa-list-alt margin-right-10px"></i>Doc. Name</label>
                                ...
                                <div class="form-group margin-bottom-20px">
                                    ...
                                    <input type="text" class="form-control form-control-sm" placeholder="any spec">
                                </div>
                                <div class="form-group margin-bottom-20px">
                                    <label><i class="fas fa-info margin-right-10px"></i> Address</label>
                                    <input type="text" class="form-control form-control-sm" placeholder="Ex. mansoura">
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control form-control-sm" placeholder="H:M:S">
                                    </div>
                                    <div class="col-md-6">
                                        <label><i class="fas fa-link margin-right-10px"></i> Stay time</label>
                                        <input type="text" class="form-control form-control-sm" placeholder="number of hours">
                                    </div>
                    ...
                    <a href="#" class="btn btn-lg border-2  btn-primary btn-block border-radius-15 padding-15px box-shadow">Add Doctor</a>
                </div>
            </div>
            <!-- /.container-fluid-->
            <!-- /.content-wrapper-->
